...
///   is unambiguous.
/// * `resolvers=` is a **coffeeblack-vpn extension** the upstream client does not
...
fn render_client_toml(
    ...
    writeln!(body, "# Generated by coffeeblack-vpn for client \"{}\"", safe_name).unwrap();
...
fn render_resolvers_txt(resolvers: &[String]) -> String {
    let mut body = String::new();
    writeln!(body, "# Generated by coffeeblack-vpn.").unwrap();
    writeln!(
        body,
